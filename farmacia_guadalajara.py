...
key_medicines = [
    ...
    'FAZIQUE', 'INCRESINA', 'XILIARXS', 'JALRA', 'JANUMET', 'KOMBIGLYZE', 'GALVUS-MET', 'VELMETIA', 
    ...
    'TELARTEQ', 'TRANSENDIS', 'ALMETEC-CO', 'AVALIDE', 'CO-DIOVAN', 'HYZAAR', 'COAPROVEL', 'TELARTEQ-URTI', 
    'LOSAR+HIDRO', 'OPENVAS', 'EXFORGE', 'ALMETEC-TRI', 'APROVASC', 'BICARTIAL', 'DUOALMETEC', 'MAXOPRESS', 
...
def clean_product_strings(medicine, descripcion, peso, presentacion, forma_farmacologica, 
                          marca, price, descount_price, promotion, today, detail_url):
    ...
    descount_price = descount_price.strip().replace("\t","").replace("\n", "")
    ...
    for medicine in key_medicines:
        ...
        try:
            ...
            try:
                ...
                promotion = ''
                try:
                    descount_price = html_source.xpath('//div[contains(@id,"productFull")]//span[contains(@id,"listPrice")]/text()')[0]
                except:
                    descount_price = "s/d"
                if descount_price == "s/d":
                    promotion = "s/p"
                else:
                    promotion = "descuento"
        ...
        for i in range(0,351, 50):
            ...
            for element in elements:
                ...
                try:
                    descount_price = element.xpath('.//div[@class="product_info"]//span[contains(@id,"listPrice")]/text()')[0].strip()
                except:
                    descount_price = "s/d"
